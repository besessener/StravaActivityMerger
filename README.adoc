...
and the following page is currently only loading recent activities into a table, showing some details and a map with polylines, BUT does not yet offer the possibility to merge activities.
