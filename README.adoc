...
It is important to choose the correct path (according to gradle settings it is `src-api`) and to set the correct generator version --> 2. The generator will be downloaded automatically.
